...
public class MenorIgual extends EBin{
	...
	public MenorIgual(E opnd1, E opnd2, int row) {
		super(opnd1, opnd2, row);
	}
	@Override
	public TipoE tipo() {
		return TipoE.MENOR_IGUAL;
	}
	...
	public void etiquetas(){
		super.etiquetas();
		Prog.cinst = Prog.cinst + this.numeroInstruccionesMenorIgual();
	}
	private int numeroInstruccionesMenorIgual() {
		return 1;
	}
	@Override
	public int getTam() {
	...
	public void codigo(){
		super.codigo();
		this.generaInstruccionesMenorIgual();
	}
	private void generaInstruccionesMenorIgual() {
		AlmacenCodigoP.addInst("menorIgual");
	}
