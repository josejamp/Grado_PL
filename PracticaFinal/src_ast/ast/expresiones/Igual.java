...
public class Igual extends EBin{
	...
	public Igual(E opnd1, E opnd2, int row) {
	...
	public void etiquetas(){
		super.etiquetas();
		Prog.cinst = Prog.cinst + this.numeroInstruccionesIgual();
	}
	private int numeroInstruccionesIgual() {
		return 1;
	}
	@Override
	public int getTam() {
	...
	public void codigo(){
		super.codigo();
		this.generaInstruccionesIgual();
	}
	private void generaInstruccionesIgual() {
		AlmacenCodigoP.addInst("igual");
	}
