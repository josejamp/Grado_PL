...
public class MayorIgual extends EBin{
	...
	public MayorIgual(E opnd1, E opnd2, int row) {
		super(opnd1, opnd2, row);
	}
	@Override
	public TipoE tipo() {
		return TipoE.MAYOR_IGUAL;
	}
	...
	public void etiquetas(){
		super.etiquetas();
		Prog.cinst = Prog.cinst + this.numeroInstruccionesMayorIgual();
	}
	private int numeroInstruccionesMayorIgual() {
		return 1;
	}
	@Override
	public int getTam() {
	...
	public void codigo(){
		super.codigo();
		this.generaInstruccionesMayorIgual();
	}
	private void generaInstruccionesMayorIgual() {
		AlmacenCodigoP.addInst("mayorIgual");
	}
