...
public class Mod extends EBin{
	...
	public Mod(E opnd1, E opnd2, int row) {
	...
	public void etiquetas(){
		super.etiquetas();
		Prog.cinst = Prog.cinst + this.numeroInstruccionesMod();
	}
	private int numeroInstruccionesMod() {
		return 1;
	}
	@Override
	public int getTam() {
	...
	public void codigo(){
		super.codigo();
		this.generaInstruccionesMod();
	}
	private void generaInstruccionesMod() {
		AlmacenCodigoP.addInst("mod");
	}
