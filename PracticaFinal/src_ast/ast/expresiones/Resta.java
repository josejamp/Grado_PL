...
public class Resta extends EBin{
	...
	public Resta(E opnd1, E opnd2, int row) {
	...
	public void etiquetas(){
		super.etiquetas();
		Prog.cinst = Prog.cinst + this.numeroInstruccionesResta();
	}
	private int numeroInstruccionesResta() {
		return 1;
	}
	@Override
	public int getTam() {
	...
	public void codigo(){
		super.codigo();
		this.generaInstruccionesResta();
	}
	private void generaInstruccionesResta() {
